        ...
        _getCoordinates: function (position) {
            if (this.support3d) {
                switch (position) {
                    case 'outleft':
                        return {
                            '-webkit-transform': 'translateX(-' + this.CSSXout + 'px) translateZ(-660px) rotateY(45deg)',
                            '-moz-transform': 'translateX(-' + this.CSSXout + 'px) translateZ(-660px) rotateY(45deg)',
                            '-o-transform': 'translateX(-' + this.CSSXout + 'px) translateZ(-660px) rotateY(45deg)',
                            '-ms-transform': 'translateX(-' + this.CSSXout + 'px) translateZ(-660px) rotateY(45deg)',
                            'transform': 'translateX(-' + this.CSSXout + 'px) translateZ(-660px) rotateY(45deg)',
                            'opacity': 1
                        };
                        break;
                    case 'outright':
                    ...
                    case 'left':
                        return {
                            '-webkit-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-400px) rotateY(25deg)',
                            '-moz-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-400px) rotateY(25deg)',
                            '-o-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-400px) rotateY(25deg)',
                            '-ms-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-400px) rotateY(25deg)',
                            'transform': 'translateX(-' + this.CSSX + 'px) translateZ(-400px) rotateY(25deg)',
                            'opacity': 1,
                            'visibility': 'visible'
                        };
                        break;
